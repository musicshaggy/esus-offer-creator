...
const DICT = {
  pl: {
    ...
    alternativeOption: "Opcja",
    primaryOption: "Wariant główny",
    alternativesSummaryNote: "Warianty alternatywne pokazane przy pozycjach maj\u0105 charakter informacyjny. Podsumowanie dotyczy wariantu g\u0142\u00f3wnego.",
    variantsImpactTitle: "Wpływ wariantów na wartość oferty",
    variantsImpactVariant: "Wariant",
    variantsImpactPrice: "Cena wariantu",
    variantsImpactDelta: "Zmiana vs główny",
    variantsImpactNewGross: "Nowa suma brutto",
  ...
  en: {
    ...
    primaryOption: "Main option",
    alternativesSummaryNote: "Alternative variants shown in item descriptions are informational. Totals are calculated for the main variant.",
    variantsImpactTitle: "Variant impact on offer value",
    variantsImpactVariant: "Variant",
    variantsImpactPrice: "Variant price",
    variantsImpactDelta: "Change vs main",
    variantsImpactNewGross: "New gross total",
    sumNet: "Net total",
    vat: "VAT",
  ...
  de: {
    ...
    alternativeOption: "Option",
    primaryOption: "Hauptvariante",
    alternativesSummaryNote: "Alternative Varianten in den Positionsbeschreibungen sind nur informativ. Die Zusammenfassung bezieht sich auf die Hauptvariante.",
    variantsImpactTitle: "Auswirkung der Varianten auf den Angebotswert",
    variantsImpactVariant: "Variante",
    variantsImpactPrice: "Variantenpreis",
    variantsImpactDelta: "Änderung vs Hauptvariante",
    variantsImpactNewGross: "Neue Bruttosumme",
    sumNet: "Netto-Summe",
    vat: "MwSt.",
  ...
  hu: {
    ...
    alternativeOption: "Opció",
    primaryOption: "Fő változat",
    alternativesSummaryNote: "A tételleírásokban szereplő alternatív változatok tájékoztató jellegűek. Az összesítés a fő változatra vonatkozik.",
    sumNet: "Nettó összeg",
    vat: "ÁFA",
